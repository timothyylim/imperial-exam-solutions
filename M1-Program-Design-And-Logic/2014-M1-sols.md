...
public int calc_time(Driver d, Car c, Distance distance, int w){
}
...
int main(){
  ...
  Car NR = new Car("NR-14", new Chassis(582), new Engine("5-cylinder...", 91, 250));
  
  Car TF = new Car("TFD-2", new Chassis(411), new Engine("4 cynlinder...", 87, 175));
