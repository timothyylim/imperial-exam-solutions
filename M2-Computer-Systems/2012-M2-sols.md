...
Integer #2 = 8001 (hex) = 1000 0000 0000 0001 (binary) = -(2^N-1)-1 = -2^15-1 = -32769 (decimal)
...
Integer #1 = F703 (hex) = 1111 0111 0000 0011 (binary) = (decimal)

Integer #2 = 0180 (hex) = 0000 0001 1000 0000 (binary) = (decimal)
